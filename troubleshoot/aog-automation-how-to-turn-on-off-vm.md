...
关于Azure Automation功能的使用请参考[链接](https://www.azure.cn/documentation/articles/automation-create-runbook-from-samples/)
...
**注意**： 这个步骤中的用户是通过AAD创建出来的，我们可以参考[这个链接](https://www.azure.cn/documentation/articles/active-directory-create-users/)来了解如何创建AAD用户。本例子是使用管理账号来做的， 
